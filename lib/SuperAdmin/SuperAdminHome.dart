import 'package:dummy_academy/Services/Academy.dart';
import 'package:dummy_academy/SuperAdmin/ModifyAcademy.dart';
import 'package:flutter/material.dart';
import 'package:dummy_academy/Shared/Home.dart';
import 'package:dummy_academy/Services/Services.dart';
import 'package:dummy_academy/SuperAdmin/AddAcademy.dart';
    ...
    return ListView.builder(
        ...
        itemBuilder: (ctx,i){
          return ListTile(
            ...
            onTap: (){
              Navigator.pushReplacement(
                  context, MaterialPageRoute(builder: (context) => ModifyAcademy(academyList: list,index: i,)));
            },
          );
        }
    );
