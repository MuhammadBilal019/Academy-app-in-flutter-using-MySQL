...
import 'package:dummy_academy/SuperAdmin/SuperAdminHome.dart';
...
class _ModifyAcademyState extends State<ModifyAcademy> {
  ...
  void initState() {
    ...
    _city = TextEditingController(text: widget.academyList[widget.index]['city']);
    _name = TextEditingController(text: widget.academyList[widget.index]['academy_name']);
    _address = TextEditingController(text: widget.academyList[widget.index]['academy_address']);
  }
  @override
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            Navigator.pushReplacement(
                context, MaterialPageRoute(builder: (context) => ModifyAcademy()));
          },
