...
class _AddAcademyState extends State<AddAcademy> {
  ...
  _add(){
    ...
    Services.addacademy(_name.text, _address.text, _email.text, _pass.text).then((result) {
      if ('success' == result) {
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => SuperHome()));
      }
    });
