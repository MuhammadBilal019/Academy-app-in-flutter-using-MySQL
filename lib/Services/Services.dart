...
class Services {
  ...
  static const ROOT = 'http://192.168.43.97/AcademyDB/actions.php';
  ...
  static Future<String> addManager(String username, String password, String role, String academyname) async {
    try {
      var map = new Map<String, dynamic>();
  ...
  static Future<String> addacademy(String academyname, String address, String username, String password) async {
    try {
      var map = new Map<String, dynamic>();
  ...
  static Future<String> addTeacher(String name, String subject, String academy) async {
    try {
      var map = new Map<String, dynamic>();
  ...
  static Future<String> addCourse(String name, String subject, String academy) async {
    try {
      var map = new Map<String, dynamic>();
  ...
  static Future<String> addStudent(String roll, String name, String class_name, String address,String phone, String academy) async {
    try {
      var map = new Map<String, dynamic>();
  ...
  static Future<List<User>> login(String email, String pass, String role) async {
    try {
      var map = new Map<String, dynamic>();
